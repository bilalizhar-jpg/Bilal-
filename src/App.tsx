...
function AppContent() {
 ...
 className="w-16 h-16 border-t-2 border-r-2 border-indigo-500 rounded-full shadow-[0_0_20px_rgba(99,102,241,0.1)]"
 />
 <motion.div
 initial={{ opacity: 0, y: 10}}
 animate={{ opacity: 1, y: 0}}
 transition={{ delay: 0.5}}
 className="mt-8 text-[10px] font-black uppercase tracking-[0.4em] text-indigo-600/60"
 >

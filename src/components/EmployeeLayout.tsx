...
export default function EmployeeLayout({ children}: EmployeeLayoutProps) {
 ...
 className={`w-full pl-10 pr-4 py-2.5 bg-slate-50 border-slate-200 text-slate-900 border rounded-xl text-xs outline-none focus:ring-2 focus:ring-indigo-500/20 transition-all`}
 />
 </div>
 </div>
 ...
 className="overflow-hidden ml-4 border-l border-slate-200 space-y-1"
 >
 ...
 className={`w-full flex items-center gap-3 px-4 py-2.5 rounded-xl transition-all duration-300 group text-red-600 hover:bg-red-50`}
 >
 ...
 <header className={`h-20 relative z-20 flex items-center justify-between px-8 border-b print:hidden bg-white/80 border-slate-200 backdrop-blur-xl`}>

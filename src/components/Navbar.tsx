...
import { Building2, Menu, X, User, Briefcase, LogOut, LayoutDashboard} from 'lucide-react';
...
export default function Navbar() {
 ...
 onClick={() => setIsOpen(false)}
 className="flex items-center justify-center gap-2 py-3 text-sm font-bold text-slate-700 border border-slate-200 rounded-xl"
 >
 ...
 <button
 onClick={handleLogout}
 className="flex items-center justify-center gap-2 py-3 text-sm font-bold text-red-600 border border-red-100 rounded-xl hover:bg-red-50"
 >
 <LogOut className="w-4 h-4"/>
 Logout
 </button>
 ...
 to="/employee-login"
 onClick={() => setIsOpen(false)}
 className="flex items-center justify-center gap-2 py-3 text-sm font-bold text-indigo-600 border border-indigo-100 rounded-xl"
 >
 ...
 to="/register"
 onClick={() => setIsOpen(false)}
 className="text-center py-3 text-sm font-bold text-white bg-indigo-600 rounded-xl shadow-lg shadow-indigo-200"
 >
 Get Started Free
 </Link>
 </>

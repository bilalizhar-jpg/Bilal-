...
export default function VendorPayments() {
  ...
  const payments = [
    { id: 'VPAY-001', vendor: 'Office Supplies Co', date: '2023-10-20', amount: 500.00, method: 'Bank Transfer', status: 'Posted' },
    { id: 'VPAY-002', vendor: 'Tech Solutions Inc', date: '2023-10-21', amount: 12500.00, method: 'Credit Card', status: 'Posted' },
  ];
      ...
      <div className="space-y-6">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div>
            ...
            <p className={`text-sm ${isDark ? 'text-slate-400' : 'text-slate-500'}`}>Track and manage vendor payments</p>
          </div>
              ...
              <tbody className="divide-y divide-slate-100 dark:divide-slate-700/50">
                {filteredPayments.map((payment, index) => (
                  ...
                  >
                    ...
                    <td className="px-4 py-3">
                      <span className={`text-sm ${isDark ? 'text-slate-300' : 'text-slate-700'}`}>{payment.vendor}</span>
                    </td>
                    <td className="px-4 py-3">

...
export default function AddProduct() {
 ...
 <button onClick={() => navigate('/crm/products')} className="p-1 hover:bg-slate-200 rounded-full">
 <X className="w-5 h-5"/>
 </button>
 </div>
 ...
 <input name="sku"value={formData.sku} onChange={handleChange} className={`${inputClass} bg-slate-100 cursor-not-allowed`} readOnly required />
 </div>
 ...
 <button type="button"onClick={() => navigate('/crm/products')} className="px-6 py-2 bg-slate-100 text-slate-800 rounded-md hover:bg-slate-200">Cancel</button>

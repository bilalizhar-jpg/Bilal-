...
export default function AddCompany() {
 ...
 <h1 className={`text-2xl font-bold text-slate-800`}>{isEditMode ? 'Edit Company' : 'Add New Company'}</h1>
 ...
 <form onSubmit={handleSubmit} className={`p-6 rounded-xl border bg-white border-slate-200`}>
 <div className="space-y-6">
 {/* Basic Info */}

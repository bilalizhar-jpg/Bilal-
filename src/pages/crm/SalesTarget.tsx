...
export default function SalesTarget() {
 ...
 const inputClass =`w-full px-3 py-2 text-sm rounded-md border bg-white border-slate-200 shadow-sm`;
 ...
 <h1 className={`text-xl font-bold text-slate-900`}>Sales Target</h1>
 </div>
 <p className="text-[11px] text-slate-500">Home &nbsp; &gt; &nbsp; <span className="font-medium text-slate-900">Sales Target</span></p>
 </div>
 ...
 <button className="p-1.5 border border-slate-200 rounded bg-white shadow-sm">
 ...
 className={`w-full pl-9 pr-4 py-2 text-xs rounded-md border bg-white border-slate-200`}
 />
 </div>
 <button 
 ...
 <div className="flex items-center justify-center gap-1.5 text-xs text-slate-900">
 ...
 <span>Show</span>
 <select className={`px-1.5 py-1 border rounded bg-white border-slate-200`}>
 <option>10</option>
 <option>25</option>
 <option>50</option>
 </select>
 ...
 <button className="p-1.5 rounded hover:bg-slate-100 disabled:opacity-30"disabled>
 ...
 <button className="w-6 h-6 flex items-center justify-center rounded hover:bg-slate-100 text-xs">2</button>
 ...
 <h2 className={`text-lg font-bold text-slate-900`}>Add Sales Target</h2>
 <button 
 ...
 <div>
 <label className={`block text-sm font-bold mb-1.5 text-slate-900`}>
 ...
 <button 
 onClick={() => setIsModalOpen(false)}
 className="px-6 py-2 text-sm font-medium bg-slate-50 text-slate-700 rounded hover:bg-slate-100 transition-colors"
 >
 Cancel
 </button>

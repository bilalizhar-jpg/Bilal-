...
`${p.discount}%`,
 ...
 className={`w-full max-w-4xl rounded-xl shadow-2xl flex flex-col max-h-[90vh] bg-white`}
 >
 {/* Modal Header */}
 <div className="flex items-center justify-between px-6 py-4 border-b border-slate-100">
 <h2 className={`text-lg font-bold text-slate-900`}>Add New Sales Order</h2>
 <button 
 ...
 className={`w-full px-3 py-2 text-xs rounded-lg border focus:outline-none focus:ring-2 focus:ring-red-500/20 transition-all bg-white border-slate-200`}
 >
 ...
 initial={{ opacity: 0, y: -10}}
 animate={{ opacity: 1, y: 0}}
 className={`mt-2 p-3 rounded-lg border text-[11px] space-y-1 bg-slate-50 border-slate-100 text-slate-500`}
 >
 {(() => {
 ...
 <label className="text-xs font-bold text-slate-600">Order Value</label>
 <input 
 type="number"
 ...
 return (
 <div className={`p-3 rounded-lg border text-right space-y-2 w-full h-full flex flex-col items-end justify-center bg-slate-50/50 border-slate-100`}>
 {currentCompany.logo && (
 <img 
 ...
 <div className={`flex items-center gap-1 p-2 border-b bg-slate-50 border-slate-200`}>
 <button className="p-1.5 rounded hover:bg-slate-200"><Bold className="w-3.5 h-3.5"/></button>
 <button className="p-1.5 rounded hover:bg-slate-200"><Italic className="w-3.5 h-3.5"/></button>
 <button className="p-1.5 rounded hover:bg-slate-200"><Underline className="w-3.5 h-3.5"/></button>
 <div className="w-px h-4 bg-slate-300 mx-1"/>
 <button className="p-1.5 rounded hover:bg-slate-200"><Link className="w-3.5 h-3.5"/></button>
 <button className="p-1.5 rounded hover:bg-slate-200"><List className="w-3.5 h-3.5"/></button>
 <button className="p-1.5 rounded hover:bg-slate-200"><ListOrdered className="w-3.5 h-3.5"/></button>
 <div className="w-px h-4 bg-slate-300 mx-1"/>
 <button className="flex items-center gap-1 px-2 py-1 rounded hover:bg-slate-200 text-[10px] font-medium">
 ...
 className={`w-full p-4 text-xs min-h-[120px] focus:outline-none bg-white`}
 />
 </div>
 </div>
 ...
 className={`w-full px-2 py-1.5 text-[11px] rounded border focus:outline-none bg-white border-slate-200`}
 >
 ...
 className={`w-full p-3 text-xs rounded-lg border focus:outline-none min-h-[80px] bg-white border-slate-200`}
 />
 </div>
 <div className="space-y-1.5">
 <label className="text-xs font-bold text-slate-600">Terms & Conditions</label>
 <textarea 
 value={terms}
 ...
 className={`w-full px-3 py-2 text-xs rounded-lg border focus:outline-none bg-white border-slate-200`}
 />
 </div>
 ...
 <button 
 onClick={() => setIsModalOpen(false)}
 className={`px-4 py-2 text-xs font-bold rounded-lg transition-colors bg-slate-100 text-slate-600 hover:bg-slate-200`}
 >
 Cancel
 </button>
 <button 
 onClick={handleSave}
 className="px-4 py-2 text-xs font-bold bg-slate-900 text-white rounded-lg hover:opacity-90 transition-opacity"
 >
 Save
 </button>
 <button 
 ...
 className={`relative w-full max-w-sm rounded-2xl shadow-2xl overflow-hidden bg-white`}
 >

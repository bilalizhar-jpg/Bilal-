...
export default function ProductDetails() {
 ...
 const inputClass =`w-full px-2 py-1 rounded border bg-white border-slate-300`;

 return (
 <AdminLayout>
 <div className="space-y-6">
 <div className="flex items-center justify-between">
 <button onClick={() => navigate('/crm/products')} className="flex items-center gap-2 text-slate-500 hover:text-slate-800">
 <ArrowLeft className="w-4 h-4"/> Back to Products
 </button>
 <div className="flex gap-2">
 <button onClick={() => window.print()} className="flex items-center gap-2 px-4 py-2 bg-slate-100 rounded-md hover:bg-slate-200">

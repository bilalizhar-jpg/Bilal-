...
`${p.discount}%`,
 ...
 <div>
 <h1 className={`text-2xl font-bold tracking-tighter text-slate-900`}>QUOTATIONS</h1>
 ...
 className={`w-full pl-10 pr-4 py-2.5 text-xs rounded-lg border focus:outline-none focus:ring-2 focus:ring-[#00FFCC]/50 bg-white border-slate-200`}
 />
 </div>
 <button 
 ...
 <button className="flex items-center gap-1.5 px-3 py-1.5 border border-slate-200 rounded bg-white text-xs font-medium shadow-sm">
 ...
 className="flex items-center gap-1.5 px-3 py-1.5 border border-slate-200 rounded bg-white text-xs font-medium shadow-sm"
 >
 ...
 exit={{ opacity: 0, y: 10}}
 className={`absolute right-0 mt-2 w-64 rounded-xl shadow-2xl border z-20 p-3 space-y-1 bg-white border-slate-100`}
 >
 {[
 ...
 <div key={col.id} className="flex items-center justify-between p-2 hover:bg-slate-50 rounded-lg transition-colors group">
 ...
 className={`relative inline-flex h-5 w-9 items-center rounded-full transition-colors focus:outline-none ${visibleColumns[col.id as keyof typeof visibleColumns] ? 'bg-[#E11D48]' : 'bg-slate-200 '}`}
 >
 <span
 ...
 <thead className={`bg-slate-50 text-slate-600 border-b border-white/10`}>
 <tr>
 ...
 <span>SHOW</span>
 <select className={`px-2 py-1.5 border rounded-lg bg-white border-slate-200`}>
 <option>10</option>
 <option>25</option>
 <option>50</option>
 </select>
 ...
 className={`relative w-full max-w-4xl rounded-xl shadow-2xl overflow-hidden bg-white`}
 >
 {/* Modal Header */}
 <div className="flex items-center justify-between px-6 py-4 border-b border-white/10">
 <h2 className={`text-lg font-bold uppercase tracking-wider text-slate-900`}>Add New Quotation</h2>
 <button 
 ...
 className={`w-full px-4 py-3 text-sm rounded-lg border appearance-none focus:outline-none focus:ring-2 focus:ring-[#00FFCC]/50 transition-all bg-white border-slate-200`}
 >
 ...
 initial={{ opacity: 0, y: -10}}
 animate={{ opacity: 1, y: 0}}
 className={`mt-2 p-4 rounded-lg border text-[11px] space-y-1 bg-slate-50 border-slate-100 text-slate-500`}
 >
 {(() => {
 ...
 className={`w-full px-4 py-3 text-sm rounded-lg border focus:outline-none focus:ring-2 focus:ring-[#00FFCC]/50 transition-all bg-white border-slate-200`}
 />
 </div>
 <div className="space-y-1.5">
 ...
 <div className={`rounded-lg border overflow-hidden border-slate-200`}>
 <div className={`flex items-center gap-1 px-3 py-2 border-b bg-slate-50 border-slate-200`}>
 ...
 className={`w-full px-4 py-3 text-sm focus:outline-none bg-white text-slate-700`}
 />
 </div>
 </div>
 ...
 className={`w-full px-3 py-2 text-xs rounded border appearance-none focus:outline-none focus:ring-1 focus:ring-[#00FFCC]/50 bg-white border-slate-200`}
 >
 ...
 className={`w-full px-3 py-2 text-xs rounded border focus:outline-none focus:ring-1 focus:ring-[#00FFCC]/50 bg-white border-slate-200`}
 />
 </td>
 <td className="py-3 pr-4">
 <input 
 ...
 {/* Totals Section */}
 <div className={`p-6 rounded-xl space-y-3 bg-slate-50/50`}>
 ...
 className={`w-full px-4 py-3 text-xs rounded-lg border focus:outline-none bg-white border-slate-200`}
 />
 </div>
 <div className="flex-1 space-y-1">
 ...
 <button 
 onClick={() => setIsModalOpen(false)}
 className={`px-6 py-2 rounded-lg text-xs font-bold uppercase tracking-wider transition-all bg-white text-slate-600 border border-slate-200 hover:bg-slate-50`}
 >
 Cancel
 </button>
 ...
 className={`fixed top-0 right-0 h-full w-80 z-[70] shadow-2xl flex flex-col bg-white`}
 >
 ...
 {/* Customer Filter */}
 <div className="space-y-4">
 <button className="flex items-center justify-between w-full text-sm font-bold text-slate-900 group">
 <div className="flex items-center gap-2">
 ...
 <div className={`p-4 rounded-xl border space-y-4 bg-slate-50/50 border-slate-100`}>
 <div className="relative">
 ...
 className={`w-full pl-9 pr-4 py-2 text-xs rounded-lg border focus:outline-none focus:ring-2 focus:ring-red-500/20 transition-all bg-white border-slate-200`}
 />
 </div>
 ...
 <span className="text-xs font-medium text-slate-600 group-hover:text-slate-900 transition-colors">{c.name}</span>
 </label>
 ))}
 </div>
 ...
 {/* Quote Date Filter */}
 <div className="space-y-4">
 <button className="flex items-center justify-between w-full text-sm font-bold text-slate-900">
 <div className="flex items-center gap-2">
 <ChevronDown className="w-4 h-4"/>
 Quote Date
 </div>
 </button>
 <div className={`p-4 rounded-xl border bg-slate-50/50 border-slate-100`}>
 <div className="relative">
 <input 
 type="date"
 value={filterQuoteDate}
 onChange={(e) => setFilterQuoteDate(e.target.value)}
 className={`w-full px-3 py-2.5 text-xs rounded-lg border focus:outline-none focus:ring-2 focus:ring-red-500/20 transition-all bg-white border-slate-200`}
 />
 </div>
 </div>
 </div>
 ...
 className={`px-4 py-2.5 rounded-lg text-xs font-bold transition-all bg-white text-slate-600 border border-slate-200 hover:bg-slate-50`}
 >
 Reset
 </button>
 <button 

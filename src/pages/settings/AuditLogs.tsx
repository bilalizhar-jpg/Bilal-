...
export default function AuditLogs() {
 ...
 <th className={`py-3 px-4 text-xs font-black uppercase tracking-widest text-slate-500`}>Timestamp</th>
 <th className={`py-3 px-4 text-xs font-black uppercase tracking-widest text-slate-500`}>User</th>
 <th className={`py-3 px-4 text-xs font-black uppercase tracking-widest text-slate-500`}>Action</th>
 <th className={`py-3 px-4 text-xs font-black uppercase tracking-widest text-slate-500`}>Module</th>
 ...
 <tr key={log.id} className={`border-b transition-colors border-slate-100 hover:bg-slate-50`}>
 <td className={`py-3 px-4 text-xs font-mono whitespace-nowrap text-slate-600`}>
 <div className="flex items-center gap-2">
 ...
 <td className="py-3 px-4">
 <span className={`px-2 py-0.5 rounded text-[10px] font-bold uppercase tracking-widest bg-indigo-50 text-indigo-700`}>
 {log.module}
 </span>
 </td>

...
export default function GeneralSettings() {
 ...
 <div className="w-24 h-24 rounded-2xl bg-slate-100 flex items-center justify-center border-2 border-dashed border-slate-200 overflow-hidden relative">
 {formData.logo ? (
 ...
 className={`w-full border rounded px-3 py-2 text-sm outline-none focus:ring-1 focus:ring-indigo-500 h-32 bg-white border-slate-200`}
 />
 </div>
 ...
 <div key={addr.id} className={`p-4 rounded-lg border bg-slate-50 border-slate-200 space-y-3`}>
 <div className="flex items-center justify-between">
 ...
 className={`w-full border rounded px-3 py-1.5 text-xs outline-none focus:ring-1 focus:ring-indigo-500 bg-white border-slate-200`}
 />
 </div>

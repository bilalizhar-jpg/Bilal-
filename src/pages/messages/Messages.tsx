...
export default function Messages() {
 ...
 return (
 <AdminLayout>
 <div className={`flex h-[calc(100vh-12rem)] border rounded-xl overflow-hidden border-slate-200 bg-white`}>
 ...
 className={`p-3 rounded-full bg-indigo-100 text-indigo-600 hover:bg-indigo-200 transition-all`}
 title="Start Video Call"
 >
 ...
 <form onSubmit={handleSendMessage} className={`flex items-end gap-2 p-2 rounded-xl border bg-white border-slate-300 focus-within:ring-2 focus-within:ring-indigo-500 focus-within:border-transparent transition-all`}>
 <textarea
 value={newMessage}
 ...
 className={`flex-1 max-h-32 min-h-[40px] bg-transparent border-none focus:ring-0 resize-none py-2 text-sm text-slate-900 placeholder-slate-400`}
 rows={1}
 />
 <button 
 type="submit"
 ...
 className={`w-full pl-9 pr-4 py-2 rounded-lg border bg-white border-slate-200 focus:outline-none focus:ring-2 focus:ring-indigo-500`}
 />
 </div>
 ...
 <div className="mb-4">
 <label className={`block text-sm font-medium mb-1 text-slate-700`}>Select Date and Time</label>
 <input
 type="datetime-local"
 value={scheduledTime}
 onChange={(e) => setScheduledTime(e.target.value)}
 className={`w-full px-3 py-2 rounded-lg border bg-white border-slate-200 focus:outline-none focus:ring-2 focus:ring-indigo-500`}
 />
 </div>
 ...
 <h3 className={`text-lg font-bold mb-4 text-slate-900`}>Incoming Video Call</h3>
...
function CreateGroupModal({ onClose, employees, currentUserId, onCreate }: CreateGroupModalProps) {
 ...
 <div>
 <label className={`block text-sm font-medium mb-1 text-slate-700`}>Add Members</label>

...
export default function Milestones() {
 ...
 <div>
 <h2 className="text-2xl font-bold text-slate-800">Milestone</h2>
 <p className="text-xs text-slate-500 mt-1">Home &gt; Milestone</p>
 </div>
 ...
 <button className={`p-2 rounded-lg border bg-white border-slate-200 text-slate-700`}>
 <RefreshCw className="w-4 h-4"/>
 </button>
 <div className="relative">
 <button 
 onClick={() => setIsColumnsOpen(!isColumnsOpen)}
 className={`p-2 rounded-lg border bg-white border-slate-200 text-slate-700`}
 >
 <Layout className="w-4 h-4"/>
 </button>
 {isColumnsOpen && (
 <div className={`absolute right-0 top-full mt-2 w-56 rounded-xl shadow-xl border z-20 p-4 bg-white border-slate-200`}>
 <h4 className={`text-sm font-bold mb-3 text-slate-800`}>Columns</h4>
 ...
 className={`w-10 h-5 rounded-full relative transition-colors ${isVisible ? 'bg-red-500' : 'bg-slate-300 '}`}
 >
 ...
 <div className={`p-4 rounded-xl border bg-white border-slate-200 shadow-sm space-y-4`}>
 ...
 className={`w-full pl-10 pr-4 py-2 rounded-lg border text-sm outline-none focus:ring-2 focus:ring-indigo-500 bg-slate-50 border-slate-200 text-slate-900`}
 />
 </div>
 <button 
 onClick={() => {
 ...
 <div className={`px-3 py-1.5 rounded-lg border text-xs font-medium flex items-center gap-2 bg-white border-slate-200 text-slate-700`}>
 Sort By
 </div>
 <div className={`px-3 py-1.5 rounded-lg border text-xs font-medium flex items-center gap-2 bg-white border-slate-200 text-slate-700`}>
 ...
 className={`px-3 py-1.5 rounded-lg border text-xs font-medium flex items-center gap-2 bg-white border-slate-200 text-slate-700`}
 >
 <Filter className="w-3 h-3"/>
 Filter
 </button>
 {isFilterOpen && (
 <div className={`absolute right-0 top-full mt-2 w-64 rounded-xl shadow-xl border z-20 overflow-hidden bg-white border-slate-200`}>
 <div className={`p-3 border-b flex justify-between items-center border-slate-100`}>
 <h4 className={`font-bold text-slate-800`}>Filter</h4>
 ...
 className={`w-full border rounded px-3 py-2 text-sm outline-none bg-white border-slate-200`}
 >
 ...
 <div className={`p-3 border-t flex gap-2 border-slate-100`}>
 <button 
 onClick={() => setFilters({ projectName: '', assignee: '', status: ''})}
 className={`flex-1 py-2 rounded-lg text-sm font-medium border border-slate-200 text-slate-600`}
 >
 Reset
 </button>
 <button 
 ...
 {visibleColumns.projectName && <td className={`px-4 py-3 text-sm font-medium text-slate-900`}>{milestone.projectName}</td>}
 {visibleColumns.milestoneId && <td className="px-4 py-3 text-sm text-slate-500">{milestone.milestoneId}</td>}
 {visibleColumns.milestoneName && <td className={`px-4 py-3 text-sm text-slate-600`}>{milestone.milestoneName}</td>}
 ...
 <button onClick={() => handleEdit(milestone)} className="p-1.5 text-slate-400 hover:text-indigo-600 hover:bg-indigo-50 rounded transition-colors">
 <Edit3 className="w-4 h-4"/>
 </button>
 <button onClick={() => handleDelete(milestone.id)} className="p-1.5 text-slate-400 hover:text-red-600 hover:bg-red-50 rounded transition-colors">
 ...
 <button onClick={() => setIsModalOpen(false)} className="p-1 rounded-full hover:bg-slate-100 text-slate-500">
 <X className="w-5 h-5"/>
 </button>
 </div>
 ...
 className={`w-full border rounded-lg px-3 py-2 text-sm outline-none focus:ring-2 focus:ring-indigo-500 bg-white border-slate-200`}
 >
 ...
 className={`px-4 py-2 rounded-lg text-sm font-bold bg-slate-100 text-slate-700 hover:bg-slate-200`}
 >
 Cancel
 </button>

...
export default function BidderDetails() {
 ...
 <div>
 <h1 className={`text-2xl font-bold text-slate-900`}>Bidder Details</h1>
 ...
 <td className={`px-4 py-3 text-slate-700`}>{bid.date}</td>
 <td className={`px-4 py-3 font-medium text-indigo-600`}>{bid.employeeName}</td>
 <td className={`px-4 py-3 text-slate-700`}>{bid.source}</td>
 <td className={`px-4 py-3 font-medium text-slate-900`}>{bid.jobTitle}</td>
 ...
 <td className="px-4 py-3">
 <span className={`px-2 py-1 rounded-md text-[10px] font-bold uppercase tracking-wider bg-purple-100 text-purple-700`}>
 {bid.bidType}
 </span>
 </td>
 <td className={`px-4 py-3 text-slate-700`}>{bid.bidRate}</td>
 <td className={`px-4 py-3 text-center text-slate-700`}>{bid.connectsToBid}</td>
 <td className={`px-4 py-3 text-center text-slate-700`}>{bid.boostedConnects}</td>
 ...
 <td className={`px-4 py-3 text-slate-700`}>{bid.hiringRate}</td>
 <td className={`px-4 py-3 text-slate-700`}>{bid.location}</td>
 <td className={`px-4 py-3 text-slate-700`}>{bid.clientSpend}</td>
 <td className="px-4 py-3">
 <div className="flex items-center justify-end gap-2">
 <button onClick={() => handleEdit(bid)} className="flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium text-slate-600 hover:text-indigo-600 hover:bg-indigo-50 rounded-lg transition-colors">
 <Edit3 className="w-3.5 h-3.5"/>
 Edit
 </button>
 <button onClick={() => handleDelete(bid.id)} className="flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium text-slate-600 hover:text-rose-600 hover:bg-rose-50 rounded-lg transition-colors">
 ...
 <div>
 <label className={`block text-xs font-bold uppercase tracking-widest mb-2 text-slate-500`}>Bidder (Employee)</label>
 <select
 ...
 <div>
 <label className={`block text-xs font-bold uppercase tracking-widest mb-2 text-slate-500`}>Source</label>
 <input
 type="text"
 ...
 <div>
 <label className={`block text-xs font-bold uppercase tracking-widest mb-2 text-slate-500`}>Job Title</label>
 <input
 type="text"
 ...
 <div>
 <label className={`block text-xs font-bold uppercase tracking-widest mb-2 text-slate-500`}>Job Link</label>
 <input
 type="url"
 ...
 <div>
 <label className={`block text-xs font-bold uppercase tracking-widest mb-2 text-slate-500`}>Profile</label>
 <select
 ...
 <div>
 <label className={`block text-xs font-bold uppercase tracking-widest mb-2 text-slate-500`}>Bid Type</label>
 <select
 ...
 <div>
 <label className={`block text-xs font-bold uppercase tracking-widest mb-2 text-slate-500`}>Bid Rate ($)</label>
 <input
 type="text"
 ...
 <div>
 <label className={`block text-xs font-bold uppercase tracking-widest mb-2 text-slate-500`}>Connects</label>
 <input
 type="number"
 ...
 <div>
 <label className={`block text-xs font-bold uppercase tracking-widest mb-2 text-slate-500`}>Boosted</label>
 <input
 type="number"
 ...
 <div className="md:col-span-2 grid grid-cols-3 gap-4 p-4 rounded-xl border border-slate-200 bg-slate-50/50">
 ...
 />
 <span className={`text-sm font-medium text-slate-700`}>Is Viewed</span>
 </label>
 <label className="flex items-center gap-3 cursor-pointer">
 <input
 type="checkbox"
 ...
 className="w-5 h-5 rounded border-slate-300 text-indigo-600 focus:ring-indigo-500"
 />
 <span className={`text-sm font-medium text-slate-700`}>Is Interviewed</span>
 </label>
 <label className="flex items-center gap-3 cursor-pointer">
 <input
 type="checkbox"
 ...
 className="w-5 h-5 rounded border-slate-300 text-indigo-600 focus:ring-indigo-500"
 />
 <span className={`text-sm font-medium text-slate-700`}>Is Hired</span>
 </label>
 </div>

 <div>
 <label className={`block text-xs font-bold uppercase tracking-widest mb-2 text-slate-500`}>Hiring Rate</label>
 <input
 type="text"
 ...
 <div>
 <label className={`block text-xs font-bold uppercase tracking-widest mb-2 text-slate-500`}>Location</label>
 <input
 type="text"
 ...
 <label className={`block text-xs font-bold uppercase tracking-widest mb-2 text-slate-500`}>Client Spend</label>
 <input
 type="text"

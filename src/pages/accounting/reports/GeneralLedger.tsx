...
export default function GeneralLedger() {
 ...
 <button className={`p-2 rounded-xl border transition-all bg-white border-slate-200 text-slate-600 hover:bg-slate-50`}>
 ...
 <div className={`w-16 h-16 mx-auto mb-4 rounded-full flex items-center justify-center bg-slate-50`}>
 ...
 <p className={`text-[10px] font-black uppercase tracking-widest mb-1 text-slate-400`}>Opening Balance</p>
 <p className={`text-sm font-bold text-slate-900`}>{formatCurrency(openingBalance)}</p>
 </div>
 <div className="p-4 border-r border-white/5">
 <p className={`text-[10px] font-black uppercase tracking-widest mb-1 text-slate-400`}>Period Debit</p>
 <p className={`text-sm font-bold text-emerald-500`}>{formatCurrency(totalDebit)}</p>
 </div>
 <div className="p-4 border-r border-white/5">
 <p className={`text-[10px] font-black uppercase tracking-widest mb-1 text-slate-400`}>Period Credit</p>
 <p className={`text-sm font-bold text-red-500`}>{formatCurrency(totalCredit)}</p>
 </div>
 <div className="p-4">
 <p className={`text-[10px] font-black uppercase tracking-widest mb-1 text-slate-400`}>Closing Balance</p>
 <p className={`text-sm font-bold text-slate-900`}>{formatCurrency(closingBalance)}</p>
 </div>
 </div>
 ...
 <th className={`py-3 px-6 text-[10px] font-black uppercase tracking-widest text-slate-400`}>Reference</th>
 <th className={`py-3 px-6 text-[10px] font-black uppercase tracking-widest text-slate-400`}>Description</th>
 <th className={`py-3 px-6 text-[10px] font-black uppercase tracking-widest text-right text-slate-400`}>Debit</th>
 <th className={`py-3 px-6 text-[10px] font-black uppercase tracking-widest text-right text-slate-400`}>Credit</th>
 <th className={`py-3 px-6 text-[10px] font-black uppercase tracking-widest text-right text-slate-400`}>Balance</th>
 </tr>
 </thead>
 <tbody>
 {/* Opening Balance Row */}
 <tr className={`border-b italic border-slate-50 bg-slate-50/20`}>
 ...
 <td className="py-3 px-6 text-xs text-right text-slate-500">-</td>
 <td className={`py-3 px-6 text-xs text-right font-bold text-slate-600`}>
 ...
 <p className={`text-[10px] uppercase tracking-wider text-slate-400`}>{line.entryDescription}</p>
 </td>
 <td className={`py-4 px-6 text-sm text-right font-mono ${line.debit > 0 ? 'text-emerald-500 font-bold' : 'text-slate-300'}`}>
 {line.debit > 0 ? formatCurrency(line.debit) : '-'}
 </td>
 <td className={`py-4 px-6 text-sm text-right font-mono ${line.credit > 0 ? 'text-red-500 font-bold' : 'text-slate-300'}`}>
 {line.credit > 0 ? formatCurrency(line.credit) : '-'}
 </td>
 <td className={`py-4 px-6 text-sm text-right font-mono font-bold text-slate-900`}>
 ...
 <p className={`text-sm text-slate-400`}>No transactions found for the selected criteria.</p>
 </td>
 </tr>
 )}
 </tbody>

...
export default function CashFlow() {
 ...
 <h3 className={`text-2xl font-mono font-black mt-1 text-slate-900`}>
 ...
 className={`bg-transparent border-none focus:ring-0 p-0 w-32 text-slate-900`}
 />
 ...
 cat === 'operating' ? ('text-emerald-600') :
 cat === 'investing' ? ('text-amber-600') :
 ('text-indigo-600')
}`}>
 {cat} Activities
 </h3>
 ...
 <div className={`pb-4 bg-slate-50/50`}>
 ...
 {/* Final Summary Row */}
 <div className={`p-6 flex flex-col md:flex-row justify-between items-center gap-4 bg-slate-50`}>

...
export default function AccountingDashboard() {
 ...
 <h3 className={`text-[10px] font-black uppercase tracking-widest mb-1 text-slate-500`}>
 {metric.title}
 </h3>
 ...
 {/* Monthly Sales */}
 <div className={`p-6 rounded-2xl border lg:col-span-2 bg-white border-slate-200`}>
 <div className="flex items-center justify-between mb-6">
 <div className="flex items-center gap-2">
 ...
 contentStyle={{ backgroundColor: '#fff', borderColor: '#e2e8f0', borderRadius: '12px'}}
 />
 <Line type="stepAfter"dataKey="sales"name="Sales Volume"stroke="#00FFCC"strokeWidth={4} dot={{ r: 6, fill: '#00FFCC', strokeWidth: 2, stroke: '#fff'}} activeDot={{ r: 8}} />
 </LineChart>
 </ResponsiveContainer>
 </div>
 </div>

...
export default function BankAccounts() {
 ...
 <p className={`text-xs font-mono mt-1 text-slate-400`}>{acc.accountNumber}</p>
 </div>
 ...
 <div className="mt-6 pt-6 border-t border-dashed border-slate-200 flex items-center justify-between gap-2">
 <button 

...
export default function BankTransactions() {
 ...
 className={`w-full pl-12 pr-4 py-3 rounded-xl border bg-white border-slate-200 text-slate-900 focus:border-indigo-600 outline-none transition-all`}
 />
 </div>
 <div className="flex gap-2">
 <button className={`flex items-center gap-2 px-4 py-3 rounded-xl border font-bold uppercase text-[10px] tracking-widest transition-all bg-white border-slate-200 text-slate-900 hover:bg-slate-50`}>
 ...
 className={`w-full max-w-md p-8 rounded-3xl shadow-2xl bg-white text-slate-900`}
 >
 ...
 className={`w-full px-4 py-3 rounded-xl border bg-slate-50 border-slate-200 focus:border-indigo-600 outline-none transition-all`}
 >
 ...
 className={`w-full px-4 py-3 rounded-xl border bg-slate-50 border-slate-200 focus:border-indigo-600 outline-none transition-all h-24 resize-none`}
 ...
 className={`flex-1 px-6 py-3 rounded-xl font-bold uppercase text-xs tracking-widest transition-all bg-slate-100 text-slate-900 hover:bg-slate-200`}
 >
 Cancel
 </button>
 <button

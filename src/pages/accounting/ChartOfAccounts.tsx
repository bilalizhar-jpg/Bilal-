...
export default function ChartOfAccounts() {
 ...
 <th className={`py-3 px-4 text-xs font-black uppercase tracking-widest text-slate-500`}>Code</th>
 <th className={`py-3 px-4 text-xs font-black uppercase tracking-widest text-slate-500`}>Account Name</th>
 <th className={`py-3 px-4 text-xs font-black uppercase tracking-widest text-slate-500`}>Type</th>
 <th className={`py-3 px-4 text-xs font-black uppercase tracking-widest text-slate-500`}>Parent</th>
 <th className={`py-3 px-4 text-xs font-black uppercase tracking-widest text-right text-slate-500`}>Balance</th>
 ...
 <tr key={account.id} className={`border-b last:border-0 transition-colors border-slate-100 hover:bg-slate-50`}>
 <td className={`py-3 px-4 text-sm font-mono text-slate-900`}>{account.code}</td>
 ...
 <td className={`py-3 px-4 text-sm font-mono text-right text-slate-900`}>

...
export default function FiscalYears() {
 ...
 className={`w-full max-w-md p-8 rounded-3xl shadow-2xl bg-white`}
 >
 <h2 className={`text-2xl font-black uppercase tracking-tight mb-6 text-slate-900`}>
 New Fiscal Year
 </h2>
 ...
 'bg-slate-50 border-slate-200 focus:ring-indigo-500/30'
}`}
 />
 </div>

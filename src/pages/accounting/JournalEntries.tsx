...
export default function JournalEntries() {
 ...
 <th className={`py-3 px-4 text-xs font-black uppercase tracking-widest text-slate-500`}>Reference</th>
 <th className={`py-3 px-4 text-xs font-black uppercase tracking-widest text-slate-500`}>Description</th>
 ...
 <tr className={`border-b transition-colors border-slate-100 hover:bg-slate-50`}>
 <td className={`py-3 px-4 text-sm text-slate-900`}>{formatDate(entry.date)}</td>
 ...
 <thead>
 <tr className={`border-b border-slate-200`}>
 <th className={`py-2 px-2 text-xs font-black uppercase tracking-widest w-1/3 text-slate-500`}>Account</th>
 <th className={`py-2 px-2 text-xs font-black uppercase tracking-widest w-1/3 text-slate-500`}>Description</th>
 <th className={`py-2 px-2 text-xs font-black uppercase tracking-widest text-right w-1/6 text-slate-500`}>Debit</th>
 <th className={`py-2 px-2 text-xs font-black uppercase tracking-widest text-right w-1/6 text-slate-500`}>Credit</th>
 ...
 <div className={`mt-2 text-sm font-medium flex items-center justify-end gap-2 text-amber-600`}>

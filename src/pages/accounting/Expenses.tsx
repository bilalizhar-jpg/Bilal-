...
export default function Expenses() {
 ...
 <th className={`py-3 px-4 text-xs font-black uppercase tracking-widest text-slate-500`}>Category</th>
 ...
 const vendor = vendors.find(v => v.id === expense.vendorId);
 return (
 <tr key={expense.id} className={`border-b transition-colors border-slate-100 hover:bg-slate-50`}>
 ...
 <td className={`py-3 px-4 text-sm font-mono text-right font-bold text-red-600`}>

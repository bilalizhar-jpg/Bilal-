...
export default function Vendors() {
 ...
 className={`p-1.5 rounded-lg transition-colors hover:bg-white text-slate-500`}
 >
 ...
 <div className={`mt-4 pt-4 border-t flex items-center justify-between border-slate-200`}>

...
export default function AwardList() {
 ...
 <td className="px-4 py-3 text-sm text-slate-600 border-r border-slate-100">{(award as any).awardName}</td>
 <td className="px-4 py-3 text-sm text-slate-600 border-r border-slate-100">{(award as any).description}</td>
 <td className="px-4 py-3 text-sm text-slate-600 border-r border-slate-100">{(award as any).giftItem}</td>
 <td className="px-4 py-3 text-sm text-slate-600 border-r border-slate-100">{(award as any).date}</td>
 <td className="px-4 py-3 text-sm text-slate-600 border-r border-slate-100">{(award as any).employeeName}</td>
 <td className="px-4 py-3 text-sm text-slate-600 border-r border-slate-100">{(award as any).awardBy}</td>

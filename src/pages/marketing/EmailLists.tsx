              ...
              <div className="mb-4">
                <div className="border border-slate-300 dark:border-slate-600 rounded-md overflow-hidden flex bg-slate-50 dark:bg-slate-900">
                  <textarea 
                    ...
                    rows={8}
                    className="w-full px-3 py-3 bg-transparent text-slate-900 dark:text-slate-100 focus:outline-none font-mono text-sm whitespace-pre overflow-x-auto"
                    spellCheck="false"
          ...
          <div className="bg-white dark:bg-slate-800 rounded-lg border border-slate-200 dark:border-slate-700 overflow-hidden">
            {emailLists.length === 0 ? (
              <div className="p-12 text-center text-slate-500 dark:text-slate-400">
                ...
                <h3 className="text-lg font-medium text-slate-900 dark:text-white">No email lists found</h3>

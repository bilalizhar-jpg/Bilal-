...
export default function SendCampaign() {
 ...
 <h2 className="text-3xl font-bold text-slate-900 mb-2">Campaign Sent Successfully!</h2>
 ...
 className="px-6 py-2 bg-white text-slate-700 border border-slate-200 rounded-md font-medium hover:bg-slate-50 transition-colors"
 >
 Back to Campaigns
 </Link>
 <Link 
 ...
 <p className="text-sm text-slate-500 mt-1">Configure your email details and select recipients</p>
 </div>
 </div>
 ...
 <div>
 <label className="block text-sm font-medium text-slate-700 mb-1">Select Email List</label>
 <select 
 value={formData.list}
 ...
 <h3 className="text-lg font-semibold text-slate-800 mb-4">Campaign Summary</h3>
 
 <div className="space-y-4 mb-6">
 <div className="flex justify-between text-sm">
 <span className="text-slate-500">Template:</span>
 <span className="font-medium text-slate-900 text-right truncate max-w-[150px]">New Campaign Template</span>
 </div>
 <div className="flex justify-between text-sm">

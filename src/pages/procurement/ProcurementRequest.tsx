      ...
      <div className="space-y-6 pb-12">
        <div className="flex justify-between items-center no-print">
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-xl font-bold text-slate-800 dark:text-white">Procurement Request</h2>
          </div>
        ...
        <div className={`max-w-4xl mx-auto p-8 shadow-xl border ${isDark ? 'bg-slate-900 border-slate-800' : 'bg-white border-slate-200'} rounded-xl space-y-8`}>
          <div className="text-center border-b border-slate-100 dark:border-slate-800 pb-6">
            <h1 className="text-2xl font-bold text-slate-900 dark:text-white uppercase tracking-wider">Stationery & Computer Item Request</h1>
              ...
              <div className="space-y-3">
                ...
                <div>
                  ...
                  {isEditing ? (
                    ...
                    <p className="text-sm font-medium text-slate-800 dark:text-white">{requestData.priority}</p>
                  )}
                </div>
                <InfoField label="HR Email (Recipient)" name="hrEmail" value={requestData.hrEmail} onChange={handleDataChange} isEditing={isEditing} isDark={isDark} />
              </div>
            </div>
          </div>
              ...
              <table className="w-full text-left border-collapse">
                <thead>
                  <tr className="bg-slate-50 dark:bg-slate-800/50 text-[10px] font-bold uppercase">
                    ...
                    {isEditing && <th className="p-3 border-b border-slate-100 dark:border-slate-800 w-10"></th>}
                  </tr>
                </thead>
                    ...
                    <tr key={item.id} className="text-sm">
                      <td className="p-3">
                        {isEditing ? (
                          ...
                          <span className="font-medium text-slate-800 dark:text-white">{item.itemName}</span>
                        )}
                      </td>
                      <td className="p-3">
                        {isEditing ? (
                      ...
                      <td className="p-3">
                        {isEditing ? (
                          ...
                          <span className="text-slate-600 dark:text-slate-400 italic">{item.description}</span>
                        )}
                      </td>
                      {isEditing && (
                        <td className="p-3">

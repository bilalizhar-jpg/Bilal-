...
export default function ProcurementSettings() {
 ...
 <h2 className="font-bold text-slate-800">Procurement Settings</h2>
 </div>
 ...
 <div className="space-y-2">
 <label className="text-sm font-bold text-slate-700">Maximum Request Amount (Auto-approve)</label>
 <input 
 type="number"
 ...
 <div className="space-y-2">
 <label className="text-sm font-bold text-slate-700">Notification Emails</label>
 <input 
 type="text"

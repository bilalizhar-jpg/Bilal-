...
export default function CompanyPolicies() {
 ...
 <p className={`text-sm text-slate-500`}>Dashboard - Company Policies</p>
 </div>
 </div>
 ...
 className="w-4 h-4 text-blue-600 border-slate-300 focus:ring-blue-500"
 />
 <span className={`text-sm text-slate-700`}>Create File</span>
 </label>
 </div>
 </div>
 ...
 <div className={`p-6 border-t flex justify-end gap-3 border-slate-100 bg-white`}>
 <button 
 type="button"
 onClick={() => setIsModalOpen(false)}

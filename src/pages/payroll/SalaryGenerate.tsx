...
export default function SalaryGenerate() {
 ...
 {/* Select Month Card */}
 <div className={`rounded-xl border bg-white border-slate-200 shadow-sm overflow-hidden h-fit`}>
 <div className="p-4 border-b border-slate-100">
 <h2 className="font-bold text-slate-800">Select salary month</h2>
 </div>
 ...
 {/* Salary List Card */}
 <div className={`lg:col-span-2 rounded-xl border bg-white border-slate-200 shadow-sm overflow-hidden`}>
 <div className="p-4 border-b border-slate-100 flex justify-between items-center">
 <h2 className="font-bold text-slate-800">Salary list</h2>
 ...
 <th className="px-4 py-3 text-xs font-bold text-slate-600 uppercase">Salary name</th>
 <th className="px-4 py-3 text-xs font-bold text-slate-600 uppercase">Generate date</th>
 <th className="px-4 py-3 text-xs font-bold text-slate-600 uppercase">Generate by</th>
 <th className="px-4 py-3 text-xs font-bold text-slate-600 uppercase">Status</th>
 <th className="px-4 py-3 text-xs font-bold text-slate-600 uppercase">Approved date</th>
 <th className="px-4 py-3 text-xs font-bold text-slate-600 uppercase">Approved by</th>
 ...
 <td className="px-4 py-3 text-sm font-medium text-slate-800">{item.salaryName}</td>
 <td className="px-4 py-3 text-sm text-slate-600">{item.generateDate}</td>
 <td className="px-4 py-3 text-sm text-slate-600">{item.generateBy}</td>
 ...
 <td className="px-4 py-3 text-sm text-slate-600">{item.approvedDate}</td>
 <td className="px-4 py-3 text-sm text-slate-600">{item.approvedBy}</td>
 <td className="px-4 py-3 text-sm">
 <div className="flex gap-2">
 {item.status === 'Pending' && (
 ...
 >
 <div className="p-4 border-b border-slate-100 flex justify-between items-center">
 <h3 className="font-bold text-slate-800">Edit Salary Generation</h3>
 <button onClick={() => setIsEditModalOpen(false)} className="p-1 hover:bg-slate-200 rounded-full">
 ...
 <div className="space-y-2">
 <label className="text-sm font-bold text-slate-700">Salary Name</label>
 <input 
 type="text"
 ...
 exit={{ opacity: 0, y: 20}}
 className={`rounded-xl shadow-2xl w-full max-w-4xl overflow-hidden bg-white`}
 >
 <div className="p-4 border-b border-slate-100 flex justify-between items-center bg-slate-50">
 <h3 className="font-bold text-slate-800">Salary Details - {viewingSalary.salaryName}</h3>
 <div className="flex gap-2">
 <button className="p-2 hover:bg-slate-200 rounded-md text-slate-600">
 <Printer className="w-5 h-5"/>
 </button>
 <button onClick={() => setIsViewModalOpen(false)} className="p-2 hover:bg-slate-200 rounded-md text-slate-600">
 <X className="w-5 h-5"/>
 </button>
 </div>
 </div>
 ...
 <div className="space-y-2">
 <p><span className="font-bold text-slate-500">Generated Date:</span> <span className="text-slate-800">{viewingSalary.generateDate}</span></p>
 <p><span className="font-bold text-slate-500">Generated By:</span> <span className="text-slate-800">{viewingSalary.generateBy}</span></p>
 </div>
 ...
 <p><span className="font-bold text-slate-500">Approved Date:</span> <span className="text-slate-800">{viewingSalary.approvedDate}</span></p>
 </div>
 </div>
 ...
 <th className="px-4 py-3 text-xs font-bold text-slate-600 uppercase">Basic Salary</th>
 <th className="px-4 py-3 text-xs font-bold text-slate-600 uppercase">Allowances</th>
 <th className="px-4 py-3 text-xs font-bold text-slate-600 uppercase">Deductions</th>
 <th className="px-4 py-3 text-xs font-bold text-slate-600 uppercase">Net Salary</th>
 </tr>
 </thead>
 ...
 <td className="px-4 py-3 text-slate-600">{settings.currency.symbol} 5,000.00</td>
 <td className="px-4 py-3 text-slate-600">{settings.currency.symbol} 500.00</td>
 <td className="px-4 py-3 text-slate-600">{settings.currency.symbol} 0.00</td>
 <td className="px-4 py-3 font-bold text-slate-800">{settings.currency.symbol} 5,500.00</td>
 </tr>
 ))}
 </tbody>
 <tfoot>
 ...
 <td className="px-4 py-3 text-slate-800">{settings.currency.symbol} 9,500.00</td>
 <td className="px-4 py-3 text-slate-800">{settings.currency.symbol} 900.00</td>
 <td className="px-4 py-3 text-slate-800">{settings.currency.symbol} 100.00</td>
 <td className="px-4 py-3 text-indigo-600">{settings.currency.symbol} 10,300.00</td>
 </tr>
 </tfoot>
 </table>
 </div>
